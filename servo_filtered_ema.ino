...
float dist_min, dist_max, dist_raw, dist_prev, dist_ema, alpha, duty; // unit: mm
...
// output the read value to the serial port
  Serial.print("Min:100,Law:");
  Serial.print(dist_raw);
  Serial.print(",ema:");
  Serial.print(dist_ema);
  Serial.print(",servo:");
  Serial.print(myservo.read());  //모터 위치 읽기
...
if(dist_ema < 180.0) {
     ...
     myservo.writeMicroseconds(map(floor(dist_ema), 180, 360, _DUTY_MIN, _DUTY_MAX));
